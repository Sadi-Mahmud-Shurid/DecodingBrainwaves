...
from channelnet.hybrid_model import HybridChannelNetModel
...
class EEGModelForCausalLM(PreTrainedModel):
    ...
    def __init__(
        ...
        if eeg_encoder is None:
            eeg_encoder = HybridChannelNetModel(config=config.eeg_encoder)
    ...
    def from_separate_pretrained(
        ...
        **kwargs,
        ...
        if eeg_encoder is None:
            ...
            eeg_encoder = HybridChannelNetModel.from_pretrained(
