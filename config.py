...
from channelnet.hybrid_config import HybridEEGModelConfig
...
class EEGModelForCausalLMConfig(PretrainedConfig):
    ...
    def __init__(self, **kwargs):
        ...
        # Use HybridEEGModelConfig if transformer parameters present, else fallback
        if 'transformer_dim' in eeg_encoder_config:
            self.eeg_encoder = HybridEEGModelConfig(**eeg_encoder_config)
        else:
